...
<%
	...
	{
	out.println("<script>alert('Your Password Change Sucessful.....!')</script>");	
	}
%>
				...
				<div class="well np">
					<div id="myCarousel" class="carousel slide homCar">
						<div class="carousel-inner">
							...
							<h3 align="center">Welcome to the E-Nursery Shopping System</h3>
						</div>
					</div>
				</div>
 ...
 -->
		<div class="copyright">
			<div class="container">
				...
				<span>Copyright &copy; Gururaj E-Nursery
					Shopping System.
				</span>
			</div>
		</div>
